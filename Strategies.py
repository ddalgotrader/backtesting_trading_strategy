...
def rsi(data, freq=30, window=14, up_level=70, down_level=30,neutral_level_dist=None, bars_ob=1, plot_data={2:[('RSI',['up_level','down_level'], 'blue')]}):
